...
class STATUS : public component {
    ...
    private:
        STATUS_ROM rom ;
        output<1> sr_n_in, sr_v_in, sr_d_in, sr_i_in, sr_z_in, sr_c_in, sr_b_in ;
        output<1> sr_nz_set, sr_v_set, sr_d_set, sr_i_set, sr_c_set ;
    public:
        STATUS() : n_in(this),  v_in(this),  d_in(this),  i_in(this),  z_in(this), c_in(this), b_in(this),
        ...
        void always(){
            ...
            if (data_enable){
                ...
                data_out.drive(true) ;
                uint8_t P = N << 7 | V << 6 | 1 << 5 | B << 4 | D << 3 | I << 2 | Z << 1 | C ;
