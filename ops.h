...
uint8_t asl(uint8_t tick) {
    if ((INST & 0xF) == 0xA){
        ...
        switch (tick) { 
            ...
            case 0x10:  C3.ALU_op = ALU_ADD ; 
                        C4.EAh_e.toggle() ; CU.EAl_e.toggle() ; C3.ALU_e.toggle() ; C5.ST_C_s.toggle() ; C5.ST_NZ_s.toggle() ; break ;
...
uint8_t bcc(uint8_t tick){
    if (! STATUS.C){ 
        switch (tick) {  
            ...
            case 0x10:  CU.EAl_e.toggle() ; C4.Al2D_e.toggle() ; break ;
            case 0x11:  CU.PCl_s.toggle() ; break ;
            case 0x12:  CU.PCl_s.toggle() ; break ;
            case 0x13:  C4.Al2D_e.toggle() ; CU.EAl_e.toggle() ; break ;
...
uint8_t dec(uint8_t tick) {
    switch (tick) { 
        case 0x00:  C3.ALU_op = ALU_DEC ; 
                    C4.EAh_e.toggle() ; CU.EAl_e.toggle() ; C3.ALU_e.toggle() ; C5.ST_NZ_s.toggle() ; break ;
...
uint8_t jsr(uint8_t tick) {
    switch (tick) { 
        case 0x00:  CU.PC_e.toggle() ; C4.Ah2D_e.toggle() ; break ;
        case 0x01:  C3.A_s.toggle() ; break ;
        case 0x02:  C3.A_s.toggle() ; break ;
        case 0x03:  C4.Ah2D_e.toggle() ; CU.PC_e.toggle() ; break ;
        
        case 0x10:  CU.PC_e.toggle() ; C4.Al2D_e.toggle() ; break ;
        case 0x11:  C3.B_s.toggle() ; break ;
        case 0x12:  C3.B_s.toggle() ; break ;
        case 0x13:  C4.Al2D_e.toggle() ; CU.PC_e.toggle() ; break ;
        
        case 0x20:  C3.ALU_op = ALU_DEC ; 
                    C3.ALU_e.toggle() ; C5.ST_ALU_C_s.toggle() ; break ;
        case 0x21:  CU.PCl_s.toggle() ; C5.ST_s.toggle() ; break ;
        case 0x22:  CU.PCl_s.toggle() ; C5.ST_s.toggle() ; break ;
        ...
        case 0x40:  C3.ALU_op = ALU_SBC ; 
                    CU.SP_e.toggle() ; C3.ALU_e.toggle() ; break ;
        case 0x41:  C4.RAM_s.toggle() ; break ;
        case 0x42:  C4.RAM_s.toggle() ; CU.SP_down.toggle() ; break ;
        case 0x43:  C3.ALU_op = 0 ; 
                    C3.ALU_e.toggle() ; CU.SP_e.toggle() ; CU.SP_down.toggle() ; break ;
        
        case 0x50:  CU.PC_e.toggle() ; C4.Al2D_e.toggle() ; break ;
        case 0x51:  C3.B_s.toggle() ; break ;
        case 0x52:  C3.B_s.toggle() ; break ;
        case 0x53:  C4.Al2D_e.toggle() ; CU.PC_e.toggle() ; break ;
        
        case 0x60:  C3.ALU_op = ALU_PASS ; 
                    CU.SP_e.toggle() ; C3.ALU_e.toggle() ; break ;
        case 0x61:  C4.RAM_s.toggle() ; break ;
        case 0x62:  C4.RAM_s.toggle() ; CU.SP_down.toggle() ; break ;
        ...
        case 0x80:  CU.EAl_e.toggle() ; C4.Al2D_e.toggle() ; break ;
        case 0x81:  CU.PCl_s.toggle() ; break ;
        case 0x82:  CU.PCl_s.toggle() ; break ;
        case 0x83:  C4.Al2D_e.toggle() ; CU.EAl_e.toggle() ; break ;
...
uint8_t pha(uint8_t tick) {
    switch (tick) {
        case 0x00:  C1.ACC_e.toggle() ; CU.SP_e.toggle() ; break ;
        case 0x01:  C4.RAM_s.toggle() ; break ;
        case 0x02:  C4.RAM_s.toggle() ; CU.SP_down.toggle() ; break ;
        case 0x03:  C1.ACC_e.toggle() ; CU.SP_e.toggle() ; CU.SP_down.toggle() ; break ;
...
uint8_t php(uint8_t tick) {
    switch (tick) {
        case 0x00:  CU.SP_e.toggle() ; C5.ST_e.toggle() ; break ;
        case 0x01:  C4.RAM_s.toggle() ; break ;
        case 0x02:  C4.RAM_s.toggle() ; CU.SP_down.toggle() ; break ;
        case 0x03:  CU.SP_e.toggle() ; C5.ST_e.toggle() ; CU.SP_down.toggle() ; break ;
...
uint8_t pla(uint8_t tick) {
    switch (tick) { 
        case 0x00:  CU.SP_e.toggle() ; C4.Al2D_e.toggle() ; break ;
        case 0x01:  C3.B_s.toggle() ; break ;
        case 0x02:  C3.B_s.toggle() ; break ;
        case 0x03:  C4.Al2D_e.toggle() ; CU.SP_e.toggle() ; break ;
        ...
        case 0x20:  CU.SP_e.toggle() ; C4.RAM_e.toggle() ; break ;
        case 0x21:  C3.B_s.toggle() ; break ;
        case 0x22:  C3.B_s.toggle() ; break ;
        case 0x23:  C4.RAM_e.toggle() ; CU.SP_e.toggle() ; break ;
...
uint8_t plp(uint8_t tick) {
    switch (tick) {
        ...
        case 0x20:  CU.SP_e.toggle() ; C4.RAM_e.toggle() ; 
        ...
        case 0x23:  CU.SP_e.toggle() ; C4.RAM_e.toggle() ; 
                    C5.ST_src.toggle() ; C5.ST_NZ_s.toggle() ; C5.ST_V_s.toggle() ; C5.ST_C_s.toggle() ; break ;
        default:    return 0 ;
    }
    return 1 ;
...
uint8_t rol(uint8_t tick) {
    if ((INST & 0xF) == 0xA){
        ...
        switch (tick) {
            ...
            case 0x12:  C4.RAM_s.toggle() ; C5.ST_s.toggle() ; break ;
            case 0x13:  C3.ALU_op = 0 ; 
                        C3.ALU_e.toggle() ; CU.EAl_e.toggle() ; C4.EAh_e.toggle() ; C5.ST_C_s.toggle() ; C5.ST_NZ_s.toggle() ; break ;
...
uint8_t ror(uint8_t tick) {
    if ((INST & 0xF) == 0xA){
        ...
        switch (tick) {
            ...
            case 0x10:  C3.ALU_op = ALU_ROR ; 
                        C3.ALU_e.toggle() ; C4.EAh_e.toggle() ; CU.EAl_e.toggle() ; C5.ST_C_s.toggle() ; C5.ST_NZ_s.toggle() ; break ;
            case 0x11:  C4.RAM_s.toggle() ; C5.ST_s.toggle() ; break ;
            case 0x12:  C4.RAM_s.toggle() ; C5.ST_s.toggle() ; break ;
            case 0x13:  C3.ALU_op = 0 ; 
                        C3.ALU_e.toggle() ; C4.EAh_e.toggle() ; CU.EAl_e.toggle() ; C5.ST_C_s.toggle() ; C5.ST_NZ_s.toggle() ; break ;
...
uint8_t rti(uint8_t tick) {
    switch (tick) { // 9 cycles
        ...
        case 0x30:  CU.SP_e.toggle() ; C4.Al2D_e.toggle() ; break ;
        case 0x31:  C3.B_s.toggle() ; break ;
        case 0x32:  C3.B_s.toggle() ; break ;
        case 0x33:  C4.Al2D_e.toggle() ; CU.SP_e.toggle() ; break ;
        ...
        case 0x50:  CU.SP_e.toggle() ; C4.RAM_e.toggle() ; break ;
        case 0x51:  CU.PCl_s.toggle() ; break ;
        case 0x52:  CU.PCl_s.toggle() ; break ;
        case 0x53:  C4.RAM_e.toggle() ; CU.SP_e.toggle() ; break ;
        
        case 0x60:  CU.SP_e.toggle() ; C4.Al2D_e.toggle() ; break ;
        case 0x61:  C3.B_s.toggle() ; break ;
        case 0x62:  C3.B_s.toggle() ; break ;
        case 0x63:  C4.Al2D_e.toggle() ; CU.SP_e.toggle() ; break ;
        ...
        case 0x80:  CU.SP_e.toggle() ; C4.RAM_e.toggle() ; break ;
        case 0x81:  C4.PCh_s.toggle() ; break ;
        case 0x82:  C4.PCh_s.toggle() ; break ;
        case 0x83:  C4.RAM_e.toggle() ; CU.SP_e.toggle() ; break ;
...
uint8_t rts(uint8_t tick) {
    switch (tick) {
        ...
        case 0x52:  C4.PCh_s.toggle() ; CU.PC_up.toggle() ; break ;
        case 0x53:  C4.RAM_e.toggle() ; CU.SP_e.toggle() ; CU.PC_up.toggle() ; break ;
...
uint8_t sta(uint8_t tick) {
    switch (tick) {
        case 0x00:  C4.EAh_e.toggle() ; CU.EAl_e.toggle() ; C1.ACC_e.toggle() ; break ;
        case 0x01:  C4.RAM_s.toggle() ; break ;
        case 0x02:  C4.RAM_s.toggle() ; break ;
        case 0x03:  C1.ACC_e.toggle() ; CU.EAl_e.toggle() ; C4.EAh_e.toggle() ; break ;
...
uint8_t stx(uint8_t tick) {
    switch (tick) {
        case 0x00:  C4.EAh_e.toggle() ; CU.EAl_e.toggle() ; C1.X_e.toggle() ; break ;
        case 0x01:  C4.RAM_s.toggle() ; break ;
        case 0x02:  C4.RAM_s.toggle() ; break ;
        case 0x03:  C1.X_e.toggle() ; CU.EAl_e.toggle() ; C4.EAh_e.toggle() ; break ;
...
uint8_t sty(uint8_t tick) {
    switch (tick) {
        case 0x00:  C4.EAh_e.toggle() ; CU.EAl_e.toggle() ; C1.Y_e.toggle() ; break ;
        case 0x01:  C4.RAM_s.toggle() ; break ;
        case 0x02:  C4.RAM_s.toggle() ; break ;
        case 0x03:  C1.Y_e.toggle() ; CU.EAl_e.toggle() ; C4.EAh_e.toggle() ; break ;
...
uint8_t rst(uint8_t tick){
    switch (tick) {
        ...
        case 0x01:  CU.SP_s.toggle() ; C5.ST_s.toggle() ; break ;
        case 0x02:  CU.SP_s.toggle() ; C5.ST_s.toggle() ; break ;
