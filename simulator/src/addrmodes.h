...
uint8_t zpx(uint8_t step) { // 5 cycles
    ...
    switch (step){
        ...
        case NEXT:  C1.X_e.toggle() ;
                    ...
                    C3.B_s.toggle() ; break ;
        case NEXT:  C3.B_s.toggle() ; break ;
        case NEXT:  C2.RAM_e.toggle() ; C2.PC_e.toggle() ;
...
uint8_t rel(uint8_t step){ // 7 cycles
    ...
    switch (step){
        ...
        case NEXT:  C2.RAM_e.toggle() ; C2.PC_e.toggle() ; C2.PC_up.toggle() ;
...
uint8_t abso(uint8_t step) { // 3 cycles
    ...
    switch(step) {
        ...
        case NEXT:  C2.PC_e.toggle() ; C2.PC_up.toggle() ;
...
uint8_t ind(uint8_t step) { // 8 cycles
    ...
    switch(step) {
        ...
        case NEXT:  C2.PC_e.toggle() ; C2.PC_up.toggle() ;
                    ...
                    C1.A_s.toggle() ; break ;
        case NEXT:  C1.A_s.toggle() ; break ;
        case NEXT:  C2.RAM_e.toggle() ; C4.EAl_e.toggle() ; C4.EAh_e.toggle() ;
...
uint8_t indx(uint8_t step) { // 10 cycles
    ...
    switch(step) {
        ...
        case NEXT:  C3.ALU_op = 0 ;
                    ...
                    C4.EAh_s.toggle() ; break ;
        case NEXT:  C4.EAh_s.toggle() ; break ;
        case NEXT:  C2.RAM_e.toggle() ; C4.EAl_e.toggle() ;
