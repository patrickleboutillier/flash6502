uint8_t fetch(uint8_t step) { // 1 cycle
    switch (step){
        case    0:  C3.STEP_clr = 1 ; C2.PC_e.toggle() ; C2.RAM_e.toggle() ; break ;
        case    1:  C2.INST_s.toggle() ; 
                    #ifdef ARDUINO
                        INST = DATA.read() ;
                    #endif
                    break ;
...
uint8_t imm(uint8_t step) { // 1 cycle
    switch (step){
        ...
        case    1:  C1.B_s.toggle() ; break ;
        case    2:  C1.B_s.toggle() ; C2.PC_up.toggle() ; break ;
        case    3:  C2.RAM_e.toggle() ; C2.PC_e.toggle() ; C2.PC_up.toggle() ;  break ;
        default:    return 0 ;
    }
    return 1 ;
...
uint8_t zp(uint8_t step) { // 3 cycles
    switch (step){
        ...
        case   10:  C1.B_s.toggle() ; C2.PC_up.toggle() ; break ;
...
uint8_t zpx(uint8_t step) { // 5 cycles
    switch (step){
        ...
        case   17:  C1.B_s.toggle() ; break ;
        case   18:  C1.B_s.toggle() ; C2.PC_up.toggle() ; break ;
...
uint8_t rel(uint8_t step){ // 7 cycles
    switch (step){
        ...
        case    2:  C1.A_s.toggle() ; C1.B_s.toggle() ; C2.PC_up.toggle() ; break ;
        case    3:  C2.RAM_e.toggle() ; C2.PC_e.toggle() ; C2.PC_up.toggle() ; break ;
...
uint8_t absx(uint8_t step) { // 7 cycles
    switch(step) {
        ...
        case    6:  C1.B_s.toggle() ; C2.PC_up.toggle() ; break ;
        case    7:  C2.RAM_e.toggle() ; C2.PC_e.toggle() ; C2.PC_up.toggle() ; break ;
...
uint8_t ind(uint8_t step) { // 8 cycles
    switch(step) {
        case    0:  C2.PC_e.toggle() ; C2.RAM_e.toggle() ; break ;
        case    1:  C4.EAl_s.toggle() ; C1.B_s.toggle() ; break ;
        case    2:  C1.B_s.toggle() ; C4.EAl_s.toggle() ; C2.PC_up.toggle() ; break ;
        case    3:  C2.RAM_e.toggle() ; C2.PC_e.toggle() ; C2.PC_up.toggle() ; break ; 
...
uint8_t indx(uint8_t step) { // 10 cycles
    switch(step) {
        ...
        case   29:  C1.B_s.toggle() ; break ;
        case   30:  C1.B_s.toggle() ; break ;
        ...
        case   37:  C1.B_s.toggle() ; break ;
        case   38:  C1.B_s.toggle() ; break ;
...
uint8_t indy(uint8_t step) { // 10 cycles
    switch(step) {
        ...
        case   41:  C1.B_s.toggle() ; break ;
        case   42:  C1.B_s.toggle() ; break ;
