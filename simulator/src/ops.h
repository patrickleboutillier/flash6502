...
uint8_t asl(uint8_t step) {
    if ((INST & 0xF) == 0xA){
        switch (step) { 
            case    0:  C1.ACC_e.toggle() ; break ;
            case    1:  C1.A_s.toggle() ; C1.B_s.toggle() ; break ;
            case    2:  C1.A_s.toggle() ; C1.B_s.toggle() ; break ;
            case    3:  C1.ACC_e.toggle() ; break ;
...
uint8_t brk(uint8_t step) {
    ...
    switch (step){
        ...
        case   27:  C3.ALU_op = 0 ; 
                    C3.ALU_e.toggle() ; break ;
        // RAM[EA] to PCh
        case   28:  C4.EAl_e.toggle() ; C4.EAl_e.toggle() ; C2.RAM_e.toggle() ; break ;
        case   29:  C4.PCh_s.toggle() ; break ;
        case   30:  C4.PCh_s.toggle() ; break ;
        case   31:  C2.RAM_e.toggle() ; C4.EAl_e.toggle() ; C4.EAl_e.toggle() ; break ;
        // DEC B (0xFF) to EAl
        case   32:  C3.ALU_op = ALU_DEC ; 
                    C3.ALU_e.toggle() ; break ;
        ...
        case   35:  C3.ALU_op = 0 ; 
                    C3.ALU_e.toggle() ; break ;
        // RAM[EA] to PCl
        case   36:  C4.EAl_e.toggle() ; C4.EAl_e.toggle() ; C2.RAM_e.toggle() ; break ;
        case   37:  C4.PCl_s.toggle() ; break ;
        case   38:  C4.PCl_s.toggle() ; break ;
        case   39:  C2.RAM_e.toggle() ; C4.EAl_e.toggle() ; C4.EAl_e.toggle() ; break ;

        case   40:  C3.STEP_clr = 0 ; break ;
...
uint8_t jsr(uint8_t step) {
    switch (step) { 
        ...
        case    5:  C1.B_s.toggle() ; break ;
        case    6:  C1.B_s.toggle() ; break ;
...
uint8_t php(uint8_t step) {
    switch (step) {
        case    0:  C2.SP_e.toggle() ; C3.ST_e.toggle() ; break ;
        case    1:  C2.RAM_s.toggle() ; break ;
        case    2:  C2.RAM_s.toggle() ; C2.SP_down.toggle() ; break ;
        case    3:  C2.SP_e.toggle() ; C3.ST_e.toggle() ; C2.SP_down.toggle() ; break ;
...
uint8_t rst1(uint8_t step){
    switch (step) {
        ...
        case    1:  C1.ACC_s.toggle() ; C1.X_s.toggle() ; C1.Y_s.toggle() ; C1.A_s.toggle() ; C1.B_s.toggle() ;
                    C2.SP_s.toggle() ; C5.ST_s.toggle() ; break ;
        case    2:  C1.ACC_s.toggle() ; C1.X_s.toggle() ; C1.Y_s.toggle() ; C1.A_s.toggle() ; C1.B_s.toggle() ;
                    C2.SP_s.toggle() ; C5.ST_s.toggle() ; break ;
